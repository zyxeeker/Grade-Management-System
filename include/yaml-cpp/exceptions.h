...
// error messages
    namespace ErrorMsg {
        ...
        inline const std::string KEY_NOT_FOUND_WITH_KEY(
                const T &, typename disable_if<is_numeric < T>>
    ...
    template<typename T>
    inline const std::string KEY_NOT_FOUND_WITH_KEY(
            const T &key, typename enable_if<is_numeric < T>>

    ::type* = 0) {
    std::stringstream stream;
    stream << KEY_NOT_FOUND << ": " <<
    key;
    return stream.
...
class YAML_CPP_API ParserException
...
class YAML_CPP_API RepresentationException
...
class YAML_CPP_API InvalidScalar
...
class YAML_CPP_API KeyNotFound
...
template<typename T>
class YAML_CPP_API TypedKeyNotFound
...
class YAML_CPP_API InvalidNode
...
class YAML_CPP_API BadConversion
...
class YAML_CPP_API BadDereference
...
class YAML_CPP_API BadSubscript
...
class YAML_CPP_API BadPushback
...
class YAML_CPP_API EmitterException
